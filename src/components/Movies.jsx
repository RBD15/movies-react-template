        ...
        <div className="row ipad-width">
                ...
                <div className="tab-content">
                    <div id="tab21" className="tab">
                        <div className="row">
                          <div className="slick-multiItem">
                            <div className="slide-it">
                              <div className="movie-item">
                                <div className="mv-img">
                                  <img src={require("../images/uploads/mv-item1.jpg")} alt="" width="185" height="284"/>
                                </div>
                                <div className="hvr-inner">
                                  <a  href="moviesingle.html"> Read more <i className="ion-android-arrow-dropright"></i> </a>
                                </div>
                      ...
                      <div className="slide-it">
                        <div className="movie-item">
                                <div className="mv-img">
                                  <img src={require("../images/uploads/mv-item2.jpg")} alt="" width="185" height="284"/>
                                </div>
                                <div className="hvr-inner">
                                  <a  href="moviesingle.html"> Read more <i className="ion-android-arrow-dropright"></i> </a>
                                </div>
                            ...
                            <div className="slide-it">
                              <div className="movie-item">
                                <div className="mv-img">
                                  <img src={require("../images/uploads/mv-item3.jpg")} alt="" width="185" height="284"/>
                                </div>
                                <div className="hvr-inner">
                                  <a  href="moviesingle.html"> Read more <i className="ion-android-arrow-dropright"></i> </a>
                                </div>
                            ...
                            <div className="slide-it">
                              <div className="movie-item">
                                <div className="mv-img">
                                  <img src={require("../images/uploads/mv-item4.jpg")} alt="" width="185" height="284"/>
                                </div>
                                <div className="hvr-inner">
                                  <a  href="moviesingle.html"> Read more <i className="ion-android-arrow-dropright"></i> </a>
                                </div>
                    ...
                    <div id="tab22" className="tab active">
                      <div className="row">
                          <div className="slick-multiItem">
                            <div className="slide-it">
                              <div className="movie-item">
                                <div className="mv-img">
                                  <img src={require("../images/uploads/mv-item5.jpg")} alt="" width="185" height="284"/>
                                </div>
                                <div className="hvr-inner">
                                  <a  href="moviesingle.html"> Read more <i className="ion-android-arrow-dropright"></i> </a>
                                </div>
                      ...
                      <div className="slide-it">
                        <div className="movie-item">
                                <div className="mv-img">
                                  <img src={require("../images/uploads/mv-item6.jpg")} alt="" width="185" height="284"/>
                                </div>
                                <div className="hvr-inner">
                                  <a  href="moviesingle.html"> Read more <i className="ion-android-arrow-dropright"></i> </a>
                                </div>
                            ...
                            <div className="slide-it">
                              <div className="movie-item">
                                <div className="mv-img">
                                  <img src={require("../images/uploads/mv-item7.jpg")} alt="" width="185" height="284"/>
                                </div>
                                <div className="hvr-inner">
                                  <a  href="moviesingle.html"> Read more <i className="ion-android-arrow-dropright"></i> </a>
                                </div>
                            ...
                            <div className="slide-it">
                              <div className="movie-item">
                                <div className="mv-img">
                                  <img src={require("../images/uploads/mv-item8.jpg")} alt="" width="185" height="284"/>
                                </div>
                                <div className="hvr-inner">
                                  <a  href="moviesingle.html"> Read more <i className="ion-android-arrow-dropright"></i> </a>
                                </div>
          ...
          <div className="col-md-4">
            <div className="sidebar">
              <div className="ads">
                <img src={require("../images/uploads/ads1.png")} alt="" width="336" height="296"/>
              </div>
              <div className="celebrities">
                <h4 className="sb-title">Spotlight Celebrities</h4>
                <div className="celeb-item">
                  <a href="#"><img src={require("../images/uploads/ava1.jpg")} alt="" width="70" height="70"/></a>
                ...
                <div className="celeb-item">
                  <a href="#"><img src={require("../images/uploads/ava2.jpg")} alt="" width="70" height="70"/></a>
                  <div className="celeb-author">
                ...
                <div className="celeb-item">
                  <a href="#"><img src={require("../images/uploads/ava3.jpg")} alt="" width="70" height="70"/></a>
                  <div className="celeb-author">
                ...
                <div className="celeb-item">
                  <a href="#"><img src={require("../images/uploads/ava4.jpg")} alt="" width="70" height="70"/></a>
                  <div className="celeb-author">
