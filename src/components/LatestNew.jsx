        ...
        <div className="container">
          <div className="row ipad-width">
            <div className="col-md-8">
              <div className="ads">
                <img src={require("../images/uploads/ads2.png")} alt="" width="728" height="106"/>
              </div>
                ...
                <ul className="tab-links-3">
                  ...
                  <div className="tab-content">
                      <div id="tab31" className="tab active">
                          <div className="row">
                            <div className="blog-item-style-1">
                              <img src={require("../images/uploads/blog-it1.jpg")} alt="" width="170" height="250"/>
                      ...
                      <div id="tab32" className="tab">
                        <div className="row">
                            <div className="blog-item-style-1">
                              <img src={require("../images/uploads/blog-it2.jpg")} alt="" width="170" height="250"/>
                              <div className="blog-it-infor">
